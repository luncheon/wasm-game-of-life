var R="./wasm_game_of_life_bg.wasm";var ae=typeof TextDecoder>"u"?(0,module.require)("util").TextDecoder:TextDecoder,T=new ae("utf-8",{ignoreBOM:!0,fatal:!0});T.decode();var S=null;function se(){return(S===null||S.buffer!==g.buffer)&&(S=new Uint8Array(g.buffer)),S}function ie(e,t){return T.decode(se().subarray(e,e+t))}var _=class{static __wrap(t){let n=Object.create(_.prototype);return n.ptr=t,n}__destroy_into_raw(){let t=this.ptr;return this.ptr=0,t}free(){let t=this.__destroy_into_raw();U(t)}constructor(t,n){let o=F(t,n);return _.__wrap(o)}random(){O(this.ptr)}get asPtr(){return $(this.ptr)}get cellsPtr(){return B(this.ptr)}get rowCount(){return K(this.ptr)>>>0}get columnCount(){return N(this.ptr)>>>0}setCellAlive(t,n,o){G(this.ptr,t,n,o)}tick(){z(this.ptr)}},j=class{static __wrap(t){let n=Object.create(j.prototype);return n.ptr=t,n}__destroy_into_raw(){let t=this.ptr;return this.ptr=0,t}free(){let t=this.__destroy_into_raw();X(t)}constructor(t,n,o,a,r){let s=H(t,n,o,a,r);return j.__wrap(s)}get width(){return W(this.ptr)>>>0}get height(){return V(this.ptr)>>>0}get dataPtr(){return Y(this.ptr)}drawCells(t){J(this.ptr,t)}};function D(){return Date.now()}function M(e,t){throw new Error(ie(e,t))}var Ae={["./wasm_game_of_life_bg.js"]:{__wbg_now_c3277d0b8a8f625b:D,__wbindgen_throw:M}};async function ce(e,t){if(typeof e=="string"){let n=await fetch(e);if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(n,t)}catch(o){if(n.headers.get("Content-Type")!="application/wasm")console.warn(o);else throw o}e=await n.arrayBuffer()}return await WebAssembly.instantiate(e,t)}var{instance:c,module:be}=await ce(R,Ae),g=c.exports.memory,U=c.exports.__wbg_universe_free,F=c.exports.universe_new,O=c.exports.universe_random,$=c.exports.universe_asPtr,B=c.exports.universe_cellsPtr,K=c.exports.universe_rowCount,N=c.exports.universe_columnCount,G=c.exports.universe_setCellAlive,z=c.exports.universe_tick,X=c.exports.__wbg_universecanvasdrawer_free,H=c.exports.universecanvasdrawer_new,W=c.exports.universecanvasdrawer_width,V=c.exports.universecanvasdrawer_height,Y=c.exports.universecanvasdrawer_dataPtr,J=c.exports.universecanvasdrawer_drawCells;var f=document.body.appendChild(document.createElement("aside"));f.style.position="fixed";f.style.top="16px";f.style.right="16px";f.style.padding="4px";f.style.background="rgba(255,255,255,.8)";f.style.whiteSpace="nowrap";f.style.userSelect="none";var w=3,m=w+1,q=[204,204,204],E=[255,255,255],C=[0,0,0],Z=([e,t,n])=>`rgb(${e},${t},${n})`,x=([e,t,n])=>(255<<24)+(n<<16)+(t<<8)+e,ue=(()=>{let e=f.appendChild(document.createElement("div"));e.style.float="right",e.style.color="hsl(150,100%,50%)",e.style.textShadow="1px 1px 1px hsl(150,100%,20%)",e.style.fontVariantNumeric="tabular-nums",e.textContent="0 fps";let t=0,n=performance.now();return setInterval(()=>{let o=performance.now();e.textContent=`${Math.round(t*1e3/(o-n))} fps`,t=0,n=o},512),()=>t++})(),de=e=>{let t,n=()=>{e(),ue(),t=requestAnimationFrame(n)};return n(),{stop:()=>t!==void 0&&cancelAnimationFrame(t)}},k=(e,t,n)=>{let{rowCount:o,columnCount:a}=e,r=new Uint8Array(g.buffer,e.cellsPtr,o*a),s=0;for(let i=0;i<o;i++)for(let l=0;l<a;l++){let p=r[s];(!n||p&2)&&t(i,l,p&1),s++}},ee=e=>{let t=e.getImageData(0,0,e.canvas.width,e.canvas.height),n=new Int32Array(t.data.buffer),o=x(q);for(let a=0;a<e.canvas.width;a+=m)for(let r=0;r<e.canvas.height;r++)n[r*e.canvas.width+a]=o;for(let a=0;a<e.canvas.height;a+=m)for(let r=0;r<e.canvas.width;r++)n[a*e.canvas.width+r]=o;e.putImageData(t,0,0)},me=(e,t)=>{e.width=m*t.columnCount+1,e.height=m*t.rowCount+1;let n=e.getContext("2d");ee(n);let o=Z(E),a=Z(C),r=(s,i,l)=>{n.fillStyle=l?a:o,n.fillRect(i*m+1,s*m+1,w,w)};return k(t,r),()=>k(t,r,!0)},pe=(e,t)=>{e.width=m*t.columnCount+1,e.height=m*t.rowCount+1;let n=e.getContext("2d");ee(n);let o=n.getImageData(0,0,e.width,e.height),a=new Int32Array(o.data.buffer),r=(p,A,u,d,b)=>{let v=p+A*e.width;for(let y=0;y<d;y++){for(let h=0;h<u;h++)a[v+h]=b;v+=e.width}},s=x(E),i=x(C),l=(p,A,u)=>{r(A*m+1,p*m+1,w,w,u?i:s)};return k(t,l),n.putImageData(o,0,0),()=>{k(t,l,!0),n.putImageData(o,0,0)}},we=(e,t)=>{let n=new j(t.asPtr,w,x(q),x(E),x(C)),o=new ImageData(new Uint8ClampedArray(g.buffer,n.dataPtr,n.width*n.height*4),n.width,n.height);e.width=n.width,e.height=n.height;let a=e.getContext("2d");return n.drawCells(!1),a.putImageData(o,0,0),()=>{n.drawCells(!1),a.putImageData(o,0,0)}},ve=e=>{let t=[];try{return e((n,o)=>(t.unshift(()=>o(n)),n))}finally{t.forEach(n=>n())}},Q=(e,t,n)=>ve(o=>{let a=o(e.createShader(e.VERTEX_SHADER),i=>e.deleteShader(i));if(e.shaderSource(a,t),e.compileShader(a),!e.getShaderParameter(a,e.COMPILE_STATUS))throw Error("vertex shader compilation failure: "+e.getShaderInfoLog(a));let r=o(e.createShader(e.FRAGMENT_SHADER),i=>e.deleteShader(i));if(e.shaderSource(r,n),e.compileShader(r),!e.getShaderParameter(r,e.COMPILE_STATUS))throw Error("fragment shader compilation failure: "+e.getShaderInfoLog(r));let s=o(e.createProgram(),i=>e.deleteProgram(i));if(e.attachShader(s,a),e.attachShader(s,r),e.linkProgram(s),!e.getProgramParameter(s,e.LINK_STATUS))throw Error("program link failure: "+e.getProgramInfoLog(s));return e.useProgram(s),s}),fe=(e,t)=>{let{columnCount:n,rowCount:o}=t;e.width=m*n+1,e.height=m*o+1;let a=String.raw,r=e.getContext("webgl2",{preserveDrawingBuffer:!0});r.viewport(0,0,e.width,e.height);{let l=Q(r,a`#version 300 es
